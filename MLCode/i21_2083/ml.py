...
for filename in sorted(glob.glob("C:\\Users\\AYESHA\\Desktop\\ML fake news detection\\MLCode\\data\\Train\\Fake\\*.txt")):
...
for filename in sorted(glob.glob("C:\\Users\\AYESHA\\Desktop\\ML fake news detection\\MLCode\\data\\Train\\Real\\*.txt")):
    with open(filename, 'r', encoding='utf-8') as f:
      i = f.read()
      sentence = unlp(i)
      news =  ''
...
with open('C:\\Users\\AYESHA\\Desktop\\ML fake news detection\\MLCode\\data\\stopwords-ur.txt', 'r' , encoding='utf-8') as f:
  stop_words = f.read()
